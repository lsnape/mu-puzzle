                             ...
                             (node [:div.container
                                    ...
                                    [:ul
                                     ...
                                     [:li [:p "Start making your webapp!"]
                                      [:ul
                                       [:li [:p "The CLJS entry point is in " (code "ui-src/mu_puzzle/ui/app.cljs")]]
                                       [:li [:p "The Clojure Ring handler is in " (code "src/mu_puzzle/service/handler.clj")]]]]
